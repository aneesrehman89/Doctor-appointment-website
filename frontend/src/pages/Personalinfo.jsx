...
const Personalinfo = () => {
  ...
  let onSubmit = async (data) => {
    ...
    try {
      const res = await fetch(`${process.env.REACT_APP_BACKEND_BASEURL}/personalinfo`, {
        method: "POST",
        headers: {
      ...
      if (res.status === 200) {
        ...
        reset();
        const userRes = await fetch(`${process.env.REACT_APP_BACKEND_BASEURL}/Users/${finalData.email}`);
